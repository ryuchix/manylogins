        ...
        <div class="blogs">
            ...
            <div class="p-2 w-full flex-col space-y-4">
                <div class="h-full rounded-md shadow-cla-pink bg-gradient-to-r from-fuchsia-50 to-pink-50 overflow-hidden">
                    ...
                    <div class="px-4 py-4">
                        <h1 class="title-font text-lg font-medium mb-1"><a href="{{ route('show.blog', ['blog' => $post->slug]) }}" class="block text-xl text-link hover:text-opacity-80">{{ $post->title }}</a></h1>
