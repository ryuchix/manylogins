                        ...
                        <tr class="border-b border-gray-200 hover:bg-gray-100">
                            <td class="py-3 px-6 text-left whitespace-nowrap">
                                <div class="flex items-center">
                                    <div class="mr-2">
                                        @if ($user->image != null)
                                        <img class="w-6 h-6 rounded-full object-cover" src="{{ asset('images/users/'.$user->image) }}"/>
                                        @else
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 w-6 h-6 rounded-full object-cover" viewBox="0 0 20 20" fill="currentColor">
                            ...
                            <td class="py-3 px-6 text-center">
                                <div class="flex item-center justify-center">
                                    <a href="{{ route('users.edit', $user->id) }}" class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110 cursor-pointer">
