                        ...
                        <tr class="border-b border-gray-200 hover:bg-gray-100">
                            ...
                            <td class="py-3 px-6 text-center">
                                <div class="flex items-center justify-center">
                                    @if ($keyword->status == 1)
                                    <a href="{{ route('search', $keyword->keyword_search->slug) }}" target="_blank" class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110 cursor-pointer">
            ...
            <div class='flex items-center justify-center mt-10 bg-gray-100'>
                <div class="flex flex-col items-center mb-8 px-4 mx-auto mt-8">
                    <div class="font-sans flex justify-end space-x-1 select-none">
                        {!! $user_searches->appends(array('status' => request()->status))->links() !!}
                    </div>
                </div>
            </div>
        </div>
